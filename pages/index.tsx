...
import { Iphone, Rock } from "../components/sceneA/model"
import Lighting from "../components/sceneA/lighting"
import PostPro from "../components/sceneA/postpro"
  ...
  return (
    <div className="w-full h-screen relative flex justify-center">
      <Suspense fallback={<Loading />}>
        ...
        <Canvas gl={{ preserveDrawingBuffer: true }} dpr={2} shadows linear flat>
